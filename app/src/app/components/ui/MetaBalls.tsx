// src/app/components/ui/MetaBalls.tsx
"use client";
...
// Funções de utilidade para o shader
...
const MetaBalls: React.FC<MetaBallsProps> = ({
  color = "#A3BAFF", // Cor de destaque do seu tema
  speed = 0.3,
  ...
  clumpFactor = 1,
  cursorBallSize = 3,
  cursorBallColor = "#A3BAFF", // Cor de destaque do seu tema
